...
public class Github {
    ...
    // ==================== 新增方法（修复 Updater.java 编译错误） ====================

    /**
     * 获取最新 Release 的 API 地址
     * @return GitHub Latest Release API URL
     */
    public static String getLatestReleaseApi() {
        return getLatestTag(); // 复用已有方法
    }

    /**
     * 获取指定 Release Asset 的 API 地址
     * @param assetId Asset ID
     * @return GitHub Release Asset API URL
     */
    public static String getReleaseAssetApi(long assetId) {
        return GITHUB_API + "/releases/assets/" + assetId;
    }
}