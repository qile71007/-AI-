...
public class EpisodeGridDialog extends DialogFragment {
    ...
    public static void show(Activity activity, List<Episode> episodes) { EpisodeGridDialog d = new EpisodeGridDialog(); if (episodes != null) d.mEpisodes.addAll(episodes); d.show(activity.getFragmentManager(), "episode_grid"); }
    @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(requireActivity()).setTitle(R.string.player_episode).setView(recycler).setNegativeButton(R.string.dialog_negative, null).create();
    }
