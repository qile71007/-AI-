...
public class LiveEpgDialog extends DialogFragment {
    ...
    public static void show(Activity activity, List<EpgData> epgData) { LiveEpgDialog d = new LiveEpgDialog(); if (epgData != null) d.mEpgData.addAll(epgData); d.show(activity.getFragmentManager(), "live_epg"); }
    @NonNull @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(requireActivity()).setTitle(R.string.player_live_epg).setView(recycler).setNegativeButton(R.string.dialog_negative, null).create();
    }
