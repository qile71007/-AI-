...
public class FileManagerFragment extends Fragment {
    ...
    private void applyConfig(String filePath) {
        ...
        try {
            ...
            // 根据类型映射到整数 type: 0=vod, 1=live, 2=wall
            int type;
     ...
     * 增加 isAdded() 检查，防止 Fragment 未附着时调用导致崩溃
     */
    public boolean onBackPressed() {
        // 关键修复：如果 Fragment 未附着，直接返回 false，让 Activity 处理
