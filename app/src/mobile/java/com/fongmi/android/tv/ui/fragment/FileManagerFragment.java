...
import com.fongmi.android.tv.ui.activity.VideoActivity;   // 新增导入
...
public class FileManagerFragment extends Fragment {
    ...
    private void showFileOptions(File file) {
        ...
        String[] items = {"删除", "重命名", "复制", "剪切", "粘贴", "设为当前配置", "编辑", "播放"}; // 新增“播放”
        builder.setItems(items, (dialog, which) -> {
            switch (which) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    if (!file.isDirectory()) playVideo(file);   // 新增播放选项
                    break;
            }
        });
        builder.setNegativeButton("取消", null);
